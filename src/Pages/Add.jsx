        ...
        fetch('http://localhost:5000/allassign', {
            ...
            .then(data => {
                if (data.acknowledged) {
                    // console.log('true');
                    toast.success('Added Assignment Sucessfully')
                }
                else{
            ...
            <div className="hero-content flex justify-center align-center">
                <div className="card flex-shrink-0 w-full shadow-2xl bg-base-100">
                    <form onSubmit={handleAdd} className="card-body">
                        <h1 className="text-center text-2xl font-bold text-rose-600">Add New Assignment</h1>
                        ...
                        <div className="form-control mt-6">
                            <button className="btn btn-error text-white">Add Now</button>
                        </div>
                    </form>
                </div>
            </div>
